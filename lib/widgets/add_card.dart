...
class _AddCardState extends State<AddCard> {
                    ...
                    Container(
                      ...
                      child: TextField(
                        decoration: InputDecoration(
                          ...
                          focusedBorder: border.copyWith(borderSide: BorderSide(color: Colors.grey)),
                          contentPadding: EdgeInsets.only(left: 8, right: 32, top: 10, bottom: 10),
  ...
  var border = OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(4)), borderSide: BorderSide(color: Colors.grey, width: 1));
}
