...
class DropOffUser extends StatefulWidget {
  ...
  DropOffUser(this.pickupPlace, this.dropOffPlace) : super();
...
class _DropOffUserState extends State<DropOffUser> {
  var selectedItem;
  TextEditingController _dropOffLocationCtrl = new TextEditingController();
  ...
  void initState() {
    ...
    super.initState();
    _dropOffLocationCtrl.text = widget.dropOffPlace.display_name.toString();
    createFavoritePlaceList();
  }

  createFavoritePlaceList() {
    listFavoritePlace.add(createFavorite("GIT Lanka - Office", "No.29 Kotte, Colombo"));
        ...
        body: ListView(
          children: <Widget>[
            Card(
              ...
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.only(bottomRight: Radius.circular(16), bottomLeft: Radius.circular(16))),
              margin: EdgeInsets.only(left: 0, right: 0, bottom: 4),
              child: Container(
                decoration:
                    BoxDecoration(borderRadius: BorderRadius.only(bottomRight: Radius.circular(16), bottomLeft: Radius.circular(16)), shape: BoxShape.rectangle, color: Colors.white, boxShadow: [
                  BoxShadow(color: Colors.grey.shade300, blurRadius: 20, offset: Offset(00, 10)),
                ]),
                ...
                child: Column(
                  ...
                  children: <Widget>[
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Container(
                              child: Text(
                                "Drop off Location",
                                style: CustomTextStyle.mediumTextStyle.copyWith(color: Colors.red.shade400),
                              ),
                    ...
                    Container(
                                ...
                                children: <Widget>[
                                  TextField(
                                    decoration: InputDecoration(
                                      ...
                                      contentPadding: EdgeInsets.only(left: 8, right: 32, top: 6, bottom: 6),
                                      // hasFloatingPlaceholder: true,
                                      hintStyle: CustomTextStyle.regularTextStyle.copyWith(color: Colors.grey, fontSize: 12),
                                      labelStyle: CustomTextStyle.regularTextStyle.copyWith(color: Colors.black, fontSize: 13),
                                    ),
                                    onChanged: (value) {
                      ...
                      decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(4)), border: Border.all(width: 1, color: Colors.grey.shade400)),
                    ),
                    SizedBox(height: 16),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                        GestureDetector(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Image(
                                image: AssetImage("assets/icons/map_marker.png"),
                                height: 16,
                                width: 16,
                                color: Colors.red,
                              ),
                              ...
                              Container(
                                child: GestureDetector(
                                  ...
                                  child: Text(
                                    ...
                                    style: CustomTextStyle.mediumTextStyle.copyWith(color: Colors.grey.shade600, fontSize: 12),
                                  ),
                                ),
                              )
                            ],
                        ...
                        GestureDetector(
                          onTap: () {
                            ...
                            //     builder: (context) => BookWithoutDestination(this.isTextWritten,widget.pickupPlace,widget.dropOffPlace)));
                          },
                          child: Container(
                            width: 40,
                            margin: EdgeInsets.only(right: 10),
                            height: 40,
                            decoration: BoxDecoration(color: this.isTextWritten ? Colors.amber : Colors.grey, shape: BoxShape.circle),
                            child: Icon(
                              Icons.arrow_forward,
                              color: Colors.white,
                            ),
  ...
  var border = OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(4)), borderSide: BorderSide(color: Colors.white, width: 1));
