...
import '../../GetDropLocation/location_drop.dart';
...
class PickupUser extends StatefulWidget {
  ...
  PickupUser(this.pickupPlace) : super();
...
class _PickupUserState extends State<PickupUser> {
  ...
  createFavoritePlaceList() {
    listFavoritePlace.add(createFavorite("DDS Techvira - Office", "No.29 Dalugama, Kelaniya"));
                  ...
                  children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                              child: Text(
                                "Pickup Location",
                                style: CustomTextStyle.mediumTextStyle.copyWith(color: Colors.greenAccent.shade400),
                              ),
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.of(context).push(new MaterialPageRoute(builder: (context) => LocationDrop(widget.pickupPlace)));
                          },
                          child: Container(
                            width: 40,
