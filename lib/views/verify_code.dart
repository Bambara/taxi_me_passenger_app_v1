...
class _VerifyCodeState extends State<VerifyCode> {
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Container(
                        child: Wrap(
                          children: <Widget>[
                            Text("Resend code in : ", style: CustomTextStyle.regularTextStyle.copyWith(color: Colors.grey)),
                            Text("00:59", style: CustomTextStyle.blackTextStyle),
                          ],
                        ),
  ...
  var border = OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(4)), borderSide: BorderSide(color: Colors.grey.shade400, width: 1));
}
