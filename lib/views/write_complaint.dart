...
class _WriteComplaintState extends State<WriteComplaint> {
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              focusedBorder: border.copyWith(borderSide: BorderSide(color: Colors.grey.shade700, width: 1))),
                        ),
                      ),
                      buildSizedBox_16(),
                      Align(
  ...
  var border = OutlineInputBorder(borderRadius: BorderRadius.circular(6), borderSide: BorderSide(color: Colors.grey.shade300, width: 1));
}
