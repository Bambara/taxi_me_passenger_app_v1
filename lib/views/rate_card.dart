        ...
        child: Stack(
          children: <Widget>[
                  ...
                  children: <Widget>[
                    ...
                    Column(
                      children: <Widget>[
                        Text(
                          "Budget",
                          style: CustomTextStyle.mediumTextStyle.copyWith(color: Colors.brown.withOpacity(0.5)),
                        ),
                        SizedBox(
                          height: 2,
                        ),
                    ...
                    Column(
                      children: <Widget>[
                        ...
                        Image(image: AssetImage("assets/icons/city.png"), color: Colors.brown.withOpacity(0.5)),
                      ],
                    ),
                    SizedBox(
                      height: 12,
                    ...
                    Column(
                      children: <Widget>[
                        ...
                        Image(image: AssetImage("assets/icons/tuk.png"), color: Colors.brown.withOpacity(0.5)),
                      ],
                    ),
                    SizedBox(
                      height: 12,
                    ...
                    Column(
                      children: <Widget>[
                        ...
                        Image(image: AssetImage("assets/icons/van.png"), color: Colors.brown.withOpacity(0.5)),
                      ],
                    )
                  ],
                ),
            ...
            Container(
              ...
              decoration: BoxDecoration(boxShadow: [BoxShadow(color: Colors.grey.shade200, blurRadius: 10, offset: Offset(1, 40))]),
